...
| -------- | -------- | ------------ | -------------- | ------------------------------------------------------------------------------------------------------------------------ | ------------------ |
| taskfold | high     | dynamic-tool | subagent_ended | definePluginEntry, registerCli, registerCommand, registerGatewayMethod, registerHttpRoute, registerService, registerTool | tools              |
...
| -------- | --------------------------- | ----- | ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- |
| taskfold | seam-inventory              | log   | observed 1 hooks, 7 registrations, and 1 manifest contracts                           | hook:subagent_ended, registration:definePluginEntry, registration:registerCli, registration:registerCommand, registration:registerGatewayMethod, registration:registerHttpRoute, registration:registerService, registration:registerTool, manifestContract:tools | -             |
| taskfold | package-metadata            | log   | selected package metadata for plugin contract checks                                  | package.json, @johnson9316-bit/taskfold, version:0.2.0                                                                                                                                                                                                           | -             |
| taskfold | declarative-contracts       | log   | fixture declares manifest contracts that can be checked without executing plugin code | tools                                                                                                                                                                                                                                                            | -             |
