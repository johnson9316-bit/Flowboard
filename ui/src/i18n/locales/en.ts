...
export const en: TranslationMap = {
  ...
  taskfoldProject: {
    ...
    documents: "Documents",
    language: "Language",
    languageChangeFailed: "Could not change Taskfold language.",
    ...
    updateProject: "Save settings",
    saveDocument: "Save document",
    projectMode: "Creation mode",
    newBlankProject: "New project",
    initializeExistingProject: "Initialize existing project",
    projectId: "Project ID",
    projectName: "Project name",
    existingWorkspace: "Local project directory",
    existingWorkspaceRequired: "A local project directory is required to initialize an existing project.",
    milestoneName: "Milestone name",
    milestoneDescription: "Description",
    cardTitle: "Card title",
    cardNotes: "Notes",
    unassigned: "Unassigned",
    unassignedHelp: "Cards without a milestone",
    unassignedRequirementHelp: "Tasks without a parent requirement",
    emptyProject: "No projects yet.",
    emptyColumn: "No cards in this milestone.",
    emptyOverview: "Create a project to start planning work.",
    cards: "{count} cards",
    active: "Active",
    completed: "Completed",
    archived: "Archived",
    ...
    completeMilestoneHelp: "All non-archived cards must be Done before completion.",
    projectArchived: "This project is archived. New cards and structural moves are unavailable.",
    archiveProjectConfirm: "Archive this project? Running work will continue, but no new work can start.",
    moveTo: "Move to",
    moveToProject: "Move to project",
    moveCard: "Move card",
    targetMilestone: "Target milestone",
    selectTargetProject: "Select a target project",
    selectTargetMilestone: "Select a target milestone",
    noActiveMilestones: "This project has no active milestones.",
    moveUp: "Move up",
    moveDown: "Move down",
    moveProjectConfirm: "Move this card to {project}? Its status and execution history will be retained.",
    status: "Status",
    groupBy: "Group by",
    groupByMilestone: "Milestone",
    groupByRequirement: "Requirement",
    ...
    execution: "Execution",
    requirementExecutionDisabled: "Requirement cards organize work. Start execution from a child task.",
    startExecution: "Start execution",
    confirmStartExecution: "Start in Worktree",
    preparingExecution: "Preparing execution...",
    executionDoneNotice: "This card is Done. Starting it creates a new execution and does not change its card status.",
    executionWorktreeNotice: "OpenClaw will run this card in a managed Worktree. Changed or unpushed work is retained after the run.",
    executionIdle: "No active Taskfold execution.",
    executionFinished: "The previous execution has ended.",
    executionStopped: "The previous execution stopped or failed.",
    executionCheckRequired: "Checking the native execution status.",
    executionRunning: "Running",
    refreshExecution: "Refresh execution",
    refreshingExecution: "Refreshing execution...",
    executionAgent: "Agent",
    executionModel: "Default model",
    executionSource: "Source checkout",
    executionBaseBranch: "Base branch",
    executionWorktree: "Worktree name",
    executionWorktreePath: "Worktree path",
    executionSession: "Session",
    executionRun: "Run",
    executionTask: "Task",
    executionPromptPreview: "Prompt preview",
    executionSessionPreview: "Session preview",
    executionTaskState: "Task state",
    openNativeChat: "Open in Chat",
    stopExecution: "Stop execution",
    stopExecutionConfirm: "Stop this execution? The card status will remain unchanged.",
    steerInstruction: "Interrupt and send a new instruction",
    steerInstructionPlaceholder: "Describe what the active agent should do next.",
    steerExecution: "Interrupt and send",
    close: "Close",
    archiveCard: "Archive card",
    ...
    sourceOfTruth: "Source of truth URL",
    repositoryUrl: "Repository URL",
    planningPath: "Planning path",
    homepageUrl: "Homepage URL",
    version: "Version",
    defaultWorkspace: "Default workspace",
    defaultWorkspaceHelp: "Optional local workspace path; access remains checked by the Gateway.",
    projectSettings: "Project settings",
    documentLibrary: "Document library",
    addDocument: "Add document",
    editDocument: "Edit document",
    editDocumentContent: "Edit",
    previewDocument: "Preview",
    unsavedDocument: "Unsaved",
    searchDocuments: "Search documents",
    documentSource: "Document source",
    allDocumentSources: "All sources",
    sourceProject: "Project material",
    sourceAiSystem: "AI system",
    groupProject: "Project materials",
    groupAiSystem: "AI system",
    richTextToolbar: "Formatting",
    formatBold: "Bold",
    formatItalic: "Italic",
    ...
    documentTarget: "Markdown file path",
    ...
    noDocuments: "No documents in this section.",
    sectionProject: "Project",
    sectionCodebase: "Codebase",
    sectionEnvironment: "Environment & release",
    sectionKnowledge: "Knowledge",
    typeMarkdown: "Markdown",
    typeJson: "JSON",
    typeLink: "Link",
    typePath: "Local path",
    typeSecretRef: "Secret reference",
    ...
    zoomOut: "Zoom out",
    fitGraph: "Fit graph",
    graphLimitReached: "Showing the first 200 active cards. Filter or archive cards to reduce the graph.",
    noGraphRelations: "No card relationships to display.",
    loading: "Loading projects...",
    connectionRequired: "Connecting to the Gateway...",
    error: "Could not update Taskfold.",
    searchProjects: "Search projects",
    includeArchived: "Include archived",
    selectDocument: "Select a document to read it.",
    refreshDocument: "Refresh document",
    readingDocument: "Reading document...",
    noDocumentContent: "This document has no readable content.",
    deliveryFacts: "Delivery facts",
    deliveryObjective: "Objective",
    deliverySummary: "Actual delivery",
    deliveryOpenItems: "Open items or blockers",
    deliveryImplementation: "Implementation",
    deliveryVerification: "Verification",
    deliveryRelease: "Release",
    deliveryNotRecorded: "Not recorded",
    saveDelivery: "Save delivery facts",
    deliveryImplementationNotStarted: "Not started",
    deliveryImplementationInProgress: "In progress",
    deliveryImplementationCodeComplete: "Code complete",
    deliveryImplementationNotApplicable: "Not applicable",
    deliveryImplementationUnknown: "Unknown",
    deliveryVerificationNotStarted: "Not started",
    deliveryVerificationPartial: "Partial",
    deliveryVerificationPassed: "Passed",
    deliveryVerificationFailed: "Failed",
    deliveryVerificationHumanRequired: "Human verification required",
    deliveryVerificationNotRequired: "Not required",
    deliveryVerificationUnknown: "Unknown",
    deliveryReleaseNotStarted: "Not started",
    deliveryReleasePending: "Pending",
    deliveryReleaseReleased: "Released",
    deliveryReleaseNotRequired: "Not required",
    deliveryReleaseUnknown: "Unknown",
    sourceReferences: "Source references",
    sourceReferenceLabel: "Label",
    sourceReferenceTarget: "Path or URL",
    sourceReferenceNote: "Note",
    addSourceReference: "Add source reference",
    noSourceReferences: "No source references.",
    save: "Save",
    proof: "Proof",
    noProof: "No proof recorded.",
    proofPassed: "Passed",
    proofFailed: "Failed",
